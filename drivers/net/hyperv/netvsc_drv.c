...
static int netvsc_change_mtu(struct net_device *ndev, int mtu)
{
	...
	/*
	 * At this point we mustn't access nvdev, because it has been freed
	 * in rndis_filter_device_remove() -> netvsc_device_remove () ->
	 * free_netvsc_device(). We should only access nvdev after the below
	 * rndis_filter_device_add() -> netvsc_device_add() is called.
	 */
